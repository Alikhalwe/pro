var Layout = {
    ...
    settings: {
        ...
        autoScrollWhenMenuIsActive: true,
    ...
    listenForBalanceLayer: function () {
        $('.nav-balance').on('click', function () {
            ...
            if (!$this.hasClass('active')) {
                ...
                $balanceLayer.addClass('activating');
                $scrollableTabs.addClass('disabled');
                ...
                // If Search Layer is active
                $balanceLayer.find('input').blur();
                $balanceLayer.removeClass('active');
                $this.addClass('rotating');
                $content.removeClass('scaled');
                getpointscenter_quick();
                setTimeout(function () {
                    $.Velocity.animate($startingPoint.children('span'), {
                        ...
                        complete: function () {
                            $this.removeClass('active rotating');
                            $overlay.removeClass('active overlay-search');
                            $balanceLayer.removeClass('activating');
                            $body.removeClass('disable-scroll');
                            $scrollableTabs.removeClass('disabled');
                        }
                    });
    ...
    listenKeyboardEvents: function () {
        ...
        $(document).keyup(function (e) {
            ...
            if (e.keyCode == 27 && $navbalance.hasClass('active')) {
                $navbalance.trigger('click');
            }
