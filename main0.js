...
function ask_yamli() {
    ...
    var strQ = "https://api.yamli.com/transliterate.ashx?word=" + searchterm + "&tool=api&account_id=000006&prot=https%3A&hostname=www.yamli.com&path=%2F&build=5447&sxhr_id=6";
    Ajax.call({
        url: strQ,
        cache: false,
        type: 'GET',
        ...
        success: function (data) {
            if (data != "") {
                if (data == "done") {
                    ...
                    if (!smallImage.src.startsWith('https')) {
